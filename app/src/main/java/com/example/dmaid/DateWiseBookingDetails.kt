    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bookings1Ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                ApartmentSize = dataSnapshot.child("apartmentsize").getValue(String::class.java).toString()
    ...
    private fun openUpdateStatusDialog(dbid: String) {
        ...
        btnUpdateData.setOnClickListener {
            ...
            if (tmaidid1.isNotEmpty())
            {
                ...
                val nn13 = n13.child(dateToStr).child(tmaidid1).child("direct_earnings")
                ...
                val att1 = at1.child(dateToStr).child(tmaidid1).child("Attendance_incentive")
            ...
            if (tmaidid1.isNotEmpty())
            {
                ...
                {
                    val n13 = FirebaseDatabase.getInstance().getReference("maidearnings")
                    val nn13 = n13.child(dateToStr).child(tmaidid1).child("category_incentive")
                    nn13.addListenerForSingleValueEvent(object : ValueEventListener {
                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                            if (dataSnapshot.exists()) {
                                var catearnings =
                                ...
                                val ref2 =
                                    FirebaseDatabase.getInstance().reference.child("maidearnings")
                                        .child(dateToStr).child(tmaidid1)
            ...
            if (tmaidid2.isNotEmpty())
            {
                ...
                val n13 = FirebaseDatabase.getInstance().getReference("maidearnings")
                val nn13 = n13.child(dateToStr).child(tmaidid2).child("direct_earnings")
                nn13.addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.exists()) {
                            var direarnings =
                            ...
                            val ref1 = FirebaseDatabase.getInstance().reference.child("maidearnings").child(dateToStr).child(tmaidid2)
                            val updates1: MutableMap<String, Any> = HashMap()
                ...
                val at1 = FirebaseDatabase.getInstance().getReference("maidearnings")
                val att1 = at1.child(dateToStr).child(tmaidid2).child("Attendance_incentive")
                att1.addListenerForSingleValueEvent(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.exists()) {
                            var attendance =
                ...
                bookings1Re.addValueEventListener(object : ValueEventListener {
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            {
                                val n13 = FirebaseDatabase.getInstance().getReference("maidearnings")
                                val nn13 = n13.child(dateToStr).child(tmaidid2).child("category_incentive")
                                nn13.addListenerForSingleValueEvent(object : ValueEventListener {
                                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                                        if (dataSnapshot.exists()) {
                                            var catearnings =
                                            ...
                                            val ref2 =
                                                FirebaseDatabase.getInstance().reference.child("maidearnings")
                                                    .child(dateToStr).child(tmaidid2)
                                            val updates2: MutableMap<String, Any> = HashMap()
