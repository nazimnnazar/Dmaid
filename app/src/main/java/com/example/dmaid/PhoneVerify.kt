...
class PhoneVerify : AppCompatActivity() {
    ...
    private lateinit var verifyBtn: ImageButton
    private lateinit var resendBtn: ImageButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val num = findViewById<TextView>(R.id.numed)
        num.text = phoneNumber
    ...
    private fun resendOTPTvVisibility() {
        ...
        inputOTP5.setText("")
        inputOTP6.setText("")
        resendBtn.visibility = View.INVISIBLE
