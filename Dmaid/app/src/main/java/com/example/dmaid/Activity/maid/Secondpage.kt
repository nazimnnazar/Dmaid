...
class Secondpage : AppCompatActivity() {
    ...
    private lateinit var sortedBookingsList: ArrayList<DateWiseBookings>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_secondpage)
        sortedBookingsList = ArrayList()
    ...
    private fun sortBookingsByDate() {
        ...
        empList.sortWith(Comparator { booking1, booking2 ->
            try {
                val parsedDate1 = dateFormat.parse(booking1.ddate)
                val parsedDate2 = dateFormat.parse(booking2.ddate)
        ...
        sortedBookingsList.addAll(empList)
    }
        ...
        dbReff1.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    sortBookingsByDate()
                    val mAdapter = AdminHomeAdapter(sortedBookingsList)
